...
import signature from '../../assets/images/STAMP.png';
                        ...
                        <div className="item">
                            <div className="about-content">
                                <div className="uk-section-title section-title">
                                    <span>About Us</span>
                                    <h2>Leading the way in AznTech Solution</h2>
                                ...
                                <div className="about-text">
                                    ...
                                    <p>We build affordable technology solutions for Different software platform, large & small. By applying modern design principles along with the latest in  web technologies, we create tailored solutions that add value by connecting people with each other, businesses with their customers, and decision makers with valuable information, while simplifying Advanced Development processes, accelerating production, and lowering costs.</p>
                                   

                                    <div className="signature">
                                        <img src={signature} alt="signature"  width="60px"/>
                                    </div>
                                </div>
                            </div>
                        </div>
